  ...
  return (
    <Section tone="light" density="normal" innerClassName="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
        <article className="lg:col-span-7 relative overflow-hidden rounded-3xl bg-navy-900 text-white p-8 md:p-10 group">
          <div
            aria-hidden
        ...
        {rest.map(({ icon: Icon, title, desc }, i) => (
          <article
            key={title}
            className={cn(
              "lg:col-span-5 group relative rounded-3xl border border-line bg-mist/50 p-7 hover:bg-white hover:border-remax-red/30 hover:shadow-card transition-all",
